# Credit to TechoTim for his work on this

# See setup-instructions folder

1. install ansible (on Ubuntu, CentOS 7 or CentOS 8)
2. create your "invesntory/my-cluster/hosts" file
3. run the bin/create_k3s.sh script to build the cluster
